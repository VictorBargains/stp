<?php if( is_active_sidebar('home_sticky_2') || is_active_sidebar('home_sticky_3') || is_active_sidebar('home_sticky_1') ): ?>
            ...
            <?php if( is_active_sidebar( 'home_sticky_2') || is_active_sidebar( 'home_sticky_3' ) ): ?>
                <div class="row">
                    <div id="sticky-sidebar-2" class="sticky-sidebar widget-area col-xs-7" role="complementary">
                        <div class="row">
                    ...
                    <div id="sticky-sidebar-3" class="sticky-sidebar widget-area col-xs-5" role="complementary">
                        <div class="row">
